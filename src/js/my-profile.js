...
async function initProfile() {
  ...
  document.querySelector('.followers p').textContent =
    profileData.followerCount;
  document.querySelector('.followings p').textContent =
    profileData.followingCount;
  document.querySelector('.profile-accountname').textContent =
...
async function getProductData() {
  const data = await fetch(`${BASE_URL}/product/${myAccountName}`, {
    method: 'get',
    headers: {
      'Content-Type': 'application/json',
      Authorization: `Bearer ${JWT_TOKEN}`,
      ...
      return `
            <li class="post-box-list" data-id="${item.id}">
                ...
                <section class="post-content">
                    <img src="./src/images/icon/s-icon-more-vertical.png" alt="" class="moreBtn" data-id="${
                      item.id
                    }">
